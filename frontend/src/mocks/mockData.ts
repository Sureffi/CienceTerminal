...
export const mockCaMentionAlerts: CaMentionAlert[] = [
  {
    ...
    coinFirstPoolCreatedAt: new Date(Date.now() - 2 * 60 * 60 * 1000).toISOString(),
    mentionCount5Min: 15,
    mentionCount15Min: 32,
    mentionCount1Hour: 78,
    replyPercentage: 20,
    quotePercentage: 15,
    retweetPercentage: 35,
    originalPostPercentage: 30,
    trendDirection5Min: 'Up',
    trendDirection15Min: 'Up',
    trendDirection1Hour: 'Up',
    lastTrendUpdate5Min: new Date(Date.now() - 2 * 60 * 1000).toISOString(),
    lastTrendUpdate15Min: new Date(Date.now() - 5 * 60 * 1000).toISOString(),
    lastTrendUpdate1Hour: new Date(Date.now() - 8 * 60 * 1000).toISOString(),
  },
  {
    id: 'mock-ca-2',
    ...
    coinSymbol: 'STAR',
    launchpad: 'Jupiter',
    coinFirstPoolCreatedAt: new Date(Date.now() - 6 * 60 * 60 * 1000).toISOString(),
    mentionCount5Min: 8,
    mentionCount15Min: 18,
    mentionCount1Hour: 42,
    replyPercentage: 25,
    quotePercentage: 10,
    retweetPercentage: 40,
    originalPostPercentage: 25,
    trendDirection5Min: 'Up',
    trendDirection15Min: 'None',
    trendDirection1Hour: 'Down',
    lastTrendUpdate5Min: new Date(Date.now() - 3 * 60 * 1000).toISOString(),
    lastTrendUpdate15Min: new Date(Date.now() - 7 * 60 * 1000).toISOString(),
    lastTrendUpdate1Hour: new Date(Date.now() - 12 * 60 * 1000).toISOString(),
  },
];
...
export const generateRandomTwitterAlert = (): TwitterAlert => {
  ...
  const baseAlert = {
    ...
    coinAge: `${Math.floor(Math.random() * 24)} hours`,
